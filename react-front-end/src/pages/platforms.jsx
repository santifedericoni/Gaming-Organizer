      ...
      <Container>
        ...
        <Grid item xs={3}>
          <FormControl component="fieldset" className={classes.formControl}>
            ...
            <Grid item xs={3}>
              <FormControlLabel
                control={<Checkbox checked={PS4} onChange={handleChange} name="PS4" />}
                label="PS4"
              />
              <FormControlLabel
                control={<Checkbox checked={Xbox_one} onChange={handleChange} name="Xbox_one" />}
                label="Xbox one"
              />
              </Grid>
              <Grid item xs={3}>
              <FormControlLabel
                control={<Checkbox checked={Switch} onChange={handleChange} name="Switch" />}
                label="Switch"
              />
             <FormControlLabel
